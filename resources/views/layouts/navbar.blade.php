<div class="navinavi bg-blue-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        <img class="h-20 w-20 mr-2 fill-current" src="../../images/leaders.svg" alt="no-logo"  width="50" >
        <span class="font-semibold text-sm sm:text-xl tracking-tight">Leaders نظام إدارة مراكز تدريب معهد </span>
    </div>
    <div class="relative">
        @auth
